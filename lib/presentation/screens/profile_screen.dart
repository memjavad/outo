...
class _ProfileDisplay extends StatelessWidget {
  ...
  const _ProfileDisplay({required this.student, required this.onEdit});
...
class _QuizHistorySection extends StatelessWidget {
  ...
  const _QuizHistorySection({this.resultsFuture});
          ...
          children: [
            ...results.map(
              (r) => Card(
                ...
                child: ListTile(
                  title: Text(
                    r.examTitle ?? AppLocalizations.of(context)!.generalQuiz,
                  ),
                  subtitle: Text(
                    r.createdAt != null
