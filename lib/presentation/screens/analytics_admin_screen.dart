...
class _AnalyticsAdminScreenState extends State<AnalyticsAdminScreen> {
        ...
        setState(() {
          _exams =
              exams
                  ...
                  .toList(); // Filter out essays for distractor analytics
  ...
  Future<void> _fetchAnalytics() async {
    ...
    try {
      ...
      final distractors = await _analyticsRepo.fetchDistractorAnalysis(
        _selectedExam!.id!,
      );
    ...
    return Scaffold(
      ...
      body:
          _isLoading
              ...
              ? Center(
                child: Text(
                  l10n.noAvailableExams ?? 'No exams available for analytics.',
                ),
              )
              : RefreshIndicator(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_kpis != null)
                        Row(
                          children: [
                            Expanded(
                              child: _buildKPICard(
                                l10n.totalStudents ?? 'Total Students',
                                _kpis!.totalStudents.toString(),
                                LucideIcons.users,
                                Colors.blue,
                              ),
                            ),
                      ...
                      Text(
                        l10n.distractorAnalysis ?? 'Distractor Analysis',
                      ...
                      if (_distractors != null && _distractors!.isNotEmpty)
                        ...
                        Container(
                          ...
                          child: Text(
                            "No analytic data yet for this exam.",
              ...
              Expanded(
                child: Column(
                  ...
                  children:
                      data.distractors.map((dist) {
                        int cIdx =
                            (dist.optionIndex >= 0 ? dist.optionIndex : 4) %
                            colors.length;
                        return Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                dist.optionIndex == -1
                                    ? "Skipped"
                                    : "Option ${String.fromCharCode(65 + dist.optionIndex)}",
                                style: const TextStyle(
