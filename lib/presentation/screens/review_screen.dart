...
class ReviewScreen extends StatelessWidget {
  ...
  final Map<int, dynamic> selectedAnswers; // questionIndex -> selectedOptionIndex (or string)
                ...
                children: [
                  ...
                  if (question.richText != null && question.richText!.trim().isNotEmpty) ...[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Theme.of(context).brightness == Brightness.dark ? Border.all(color: Colors.white.withValues(alpha: 0.05)) : Border.all(color: const Color(0xFFE2E8F0)),
                      ),
                      child: MarkdownBody(
                  ...
                  if (question.questionType == 'short_answer') ...[
                    Builder(builder: (context) {
                      ...
                      final isCorrect = providedAnswer.trim().toLowerCase() == correctAnswer.trim().toLowerCase();
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          Container(
                          ...
                          if (!isCorrect) ...[
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    l10n.localeName == 'ar' ? 'الإجابة الصحيحة:' : 'Correct Answer:',
                                    style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.green),
                                  ),
                                  Text(correctAnswer, style: const TextStyle(color: Colors.green)),
                                ],
                              ),
                            ),
                          ],
                    ...
                    ...List.generate(question.questionType == 'true_false' ? 2 : question.options.length, (optIndex) {
                      bool isSelected = selectedOption == optIndex;
                      bool isCorrect = question.correctAnswerIndex == optIndex;
                      
                      Color bgColor = Colors.transparent;
                      Color borderColor = Theme.of(context).brightness == Brightness.dark ? Colors.white.withValues(alpha: 0.12) : const Color(0xFFE2E8F0);
                      IconData? icon;
