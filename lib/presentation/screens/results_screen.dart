  ...
  Widget build(BuildContext context) {
    ...
    final isEssayState =
        ...
        (widget.questions.isNotEmpty &&
            widget.questions.first.questionType == 'essay');

    return Scaffold(
      backgroundColor: theme.scaffoldBackgroundColor,
      body: Stack(
        children: [
          ..._buildBackgroundShapes(context, colorScheme),
          Container(
            ...
            child: SafeArea(
              child: Column(
                ...
                children: [
                  _buildHeader(l10n, theme, colorScheme, isEssayState),
                  const SizedBox(height: 40),
                  _buildScoreIndicator(l10n, theme, colorScheme, isEssayState),
                  const SizedBox(height: 40),
                  _buildStatsCard(l10n, theme, colorScheme, isEssayState),
                  const SizedBox(height: 40),
                  ..._buildActionButtons(
                    l10n,
                    theme,
        ...
        children: [
          if (isEssayState) ...[
            ...
            SizedBox(
              ...
              child: Text(
                l10n.localeName == 'ar'
                    ? 'سيتم إشعارك حين يقوم الأستاذ بتقييم واجبك'
            ...
            Row(
              ...
              children: List.generate(3, (starIndex) {
                ...
                return Padding(
                    ...
                    .animate(delay: (300 + starIndex * 200).ms)
                    .scaleXY(begin: 0, end: 1.0, curve: Curves.elasticOut);
              }),
            ),
            const SizedBox(height: 16),
            Text(
              l10n.localeName == 'ar'
                  ? '${widget.result.campaignScore} نقطة'
                  : '${widget.result.campaignScore} Pts',
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(
                    l10n.localeName == 'ar' ? 'إعادة' : 'Redo Level',
              ...
              Expanded(
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      l10n.localeName == 'ar' ? 'المستوى التالي' : 'Next Level',
