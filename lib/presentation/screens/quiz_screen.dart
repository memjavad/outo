...
class _QuizScreenState extends State<QuizScreen> with WidgetsBindingObserver {
        ...
        if (widget.exam?.examType == 'essay') {
          if (_selectedAnswers.containsKey(0) &&
            ...
            try {
              ...
              final doc =
                  quill.Document()..insert(0, _selectedAnswers[0].toString());
              _quillController = quill.QuillController(
                document: doc,
                selection: const TextSelection.collapsed(offset: 0),
              );
  ...
  void _submitQuiz(List<QuizQuestion> questions, {String? cheatFlag}) async {
    ...
    final quizService =
        mounted ? Provider.of<QuizService>(context, listen: false) : null;
      ...
      if (success && mounted) {
        setState(() {
          if (itemKey == 'time_freeze') {
            ...
            final otherIndices =
                _shuffledOptionIndices[_currentQuestionIndex]
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            SafeArea(
              child: SingleChildScrollView(
                padding: EdgeInsets.only(
                  top:
                      (widget.exam?.examType == 'essay' && !_isReviewingEssay)
                          ? 120
                          : 80,
                  ...
                  children: [
                    ...
                    if (widget.exam?.examType == 'campaign')
                      ValueListenableBuilder<int>(
                        ...
                        builder: (context, _, child) {
                          ...
                          double timeProgress =
                              maxTime > 0
                                  ? _questionTimeRemainingSeconds / maxTime
                                  : 0;
                    ...
                    if (question.questionType == 'short_answer' ||
                        ...
                        child:
                            question.questionType == 'essay' &&
                                ...
                                : TextFormField(
                                  ...
                                  maxLines: null,
                                  minLines:
                                      question.questionType == 'essay' ? 15 : 1,
                                  keyboardType:
                                      question.questionType == 'essay'
                      ...
                      ...List.generate(
                        ...
                        (index) {
                          final originalIndex =
                              _shuffledOptionIndices[_currentQuestionIndex][index];
                          final isSelected =
                              _selectedAnswers[_currentQuestionIndex] ==
                              originalIndex;
                          final isEliminated = _eliminatedOptions.contains(
                            originalIndex,
                          );
                                ...
                                setState(() {
                                  ...
                                  if (widget.exam?.examType == 'campaign') {
                                    int levelMatch =
                                        ...
                                        0;
                                    _questionTimeRemainingSeconds =
                                        _getCampaignQuestionTime(levelMatch);
                                  } else {
                                    _questionTimeRemainingSeconds =
                                        widget.exam?.questionTimerSeconds ?? 0;
                                  }
      ...
      endDrawer:
          (widget.exam?.allowBacktracking ?? false)
